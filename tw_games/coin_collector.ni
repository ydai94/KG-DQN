...
The scullery part 0 is some text that varies. The scullery part 0 is "Ah, the scullery. This is some kind of scullery, really great normal vibes in this place, a wonderful normal atmosphere. And now, well, you're in it.
...
The description of o_0 is "The coin seems out of place here".
...
Test quest0_0 with "go north / go north / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First thing I need you to do is to make an effort to move north. Then, try to move north. Then, head east. Once you finish that, venture east. Then, ".
The objective part 1 is some text that varies. The objective part 1 is "lift the coin from the floor of the pantry. That's it!".
